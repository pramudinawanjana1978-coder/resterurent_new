...
export const allDishes = {
  ...
  Lunch:[
    ...
    {id:102,name:"Chicken Wrap",      image:"/images/Chicken Wrap.jpg",price:"Rs. 1,750",emoji:"🥙",color:"#E8F5E9",desc:"Grilled chicken, lettuce, tzatziki in flatbread", rating:4.7,reviews:72,ingredients:["Chicken Breast","Flatbread","Lettuce","Tzatziki","Tomato"]},
    ...
    {id:104,name:"Tom Kha Soup",      image:"/images/Tom Kha Soup.jpg",price:"Rs. 1,600",emoji:"🍜",color:"#F3E5F5",desc:"Coconut broth with galangal & mushrooms",        rating:4.8,reviews:91,ingredients:["Coconut Milk","Galangal","Mushrooms","Lemongrass","Lime"]},
  ...
  Dinner:[
    {id:201,name:"Grilled Ribeye",    image:"/images/Grilled Ribeye.jpg",price:"Rs. 4,800",emoji:"🥩",color:"#FBE9E7",desc:"300g prime ribeye, chimichurri & truffle fries",  rating:4.9,reviews:188,ingredients:["Ribeye Steak","Chimichurri","Truffle","Fries","Rosemary"]},
    {id:202,name:"Roast Chicken",     image:"/images/Roast Chicken.jpg",price:"Rs. 3,340",emoji:"🍗",color:"#FFF8E1",desc:"Herb-rubbed half chicken with roasted vegetables",rating:4.7,reviews:134,ingredients:["Chicken","Mixed Herbs","Root Vegetables","Garlic","Butter"]},
    {id:203,name:"Lamb Cutlets",      image:"/images/Lamb Cutlets.jpg",price:"Rs. 4,200",emoji:"🍖",color:"#FFEBEE",desc:"French-trimmed lamb with rosemary jus & gratin",  rating:4.8,reviews:97, ingredients:["Lamb Cutlets","Rosemary","Potato Gratin","Red Wine Jus","Mint"]},
  ...
  Desserts:[
    ...
    {id:302,name:"NY Cheesecake",     image:"/images/NY Cheesecake.jpg",price:"Rs. 1,300",emoji:"🍰",color:"#FFF8E1",desc:"Velvety cream cheese on graham cracker base",       rating:4.7,reviews:156,ingredients:["Cream Cheese","Graham Cracker","Eggs","Vanilla","Sour Cream"]},
    {id:303,name:"Crème Brûlée",      image:"/images/Crème Brûlée.jpg",price:"Rs. 1,230",emoji:"🍮",color:"#FFF3E0",desc:"Classic vanilla custard with caramelised top",      rating:4.8,reviews:133,ingredients:["Heavy Cream","Eggs","Vanilla","Sugar","Caramel"]},
  ...
  Drinks:[
    {id:401,name:"Cold Brew Coffee",  image:"/images/Cold Brew Coffee.jpg",price:"Rs.  870",emoji:"☕",color:"#FFF8E1",desc:"18-hour steeped single-origin cold brew over ice", rating:4.7,reviews:88, ingredients:["Single Origin Coffee","Filtered Water","Ice","Optional Oat Milk"]},
    {id:402,name:"Mango Bubble Tea",  image:"/images/Mango Bubble Tea.jpg",price:"Rs.  940",emoji:"🧋",color:"#FFF3E0",desc:"Fresh mango milk tea with tapioca pearls",         rating:4.8,reviews:114,ingredients:["Mango Puree","Milk Tea","Tapioca Pearls","Sugar","Ice"]},
    {id:403,name:"Green Smoothie",    image:"/images/Green Smoothie.jpg",price:"Rs. 1,160",emoji:"🥤",color:"#E8F5E9",desc:"Spinach, banana, mango, coconut water blend",     rating:4.5,reviews:61, ingredients:["Spinach","Banana","Mango","Coconut Water","Chia Seeds"]},
    {id:404,name:"Classic Mojito",    image:"/images/Classic Mojito.jpg",price:"Rs. 1,450",emoji:"🍹",color:"#F1F8E9",desc:"Muddled mint, lime, rum & sparkling soda",        rating:4.7,reviews:79, ingredients:["White Rum","Lime","Mint","Sugar","Soda Water"]},
