...
export const allDishes = {
  Breakfast:[
    {id:1, name:"Blueberry Pancakes",  image:"/images/pancake2.jpg", price:"Rs. 1,850", emoji:"🥞", color:"#FFF3E0", desc:"Fluffy stacks with fresh blueberries & maple syrup",  ingredients:["Flour","Eggs","Blueberries","Maple Syrup","Butter"], subcategory:"Western Breakfast Favorites"},
    {id:2, name:"Eggs Benedict",       image:"/images/Eggs_Benedict.jpg", price:"Rs. 2,100", emoji:"🍳", color:"#FFF8E1", desc:"Poached eggs on English muffin with hollandaise",   ingredients:["Eggs","Canadian Bacon","English Muffin","Hollandaise","Chives"], subcategory:"Western Breakfast Favorites"},
    {id:3, name:"Avocado Toast",       image:"/images/avacado_toast.jpg", price:"Rs. 1,600", emoji:"🥑", color:"#F1F8E9", desc:"Smashed avo on sourdough with poached egg",            ingredients:["Avocado","Sourdough","Egg","Chilli Flakes","Lemon"], subcategory:"Light Bites & Sandwiches"},
    {id:4, name:"French Toast",        image:"/images/French_Toast.jpg", price:"Rs. 1,750", emoji:"🍞", color:"#FFF3E0", desc:"Brioche dipped in custard, dusted with powdered sugar", ingredients:["Brioche","Eggs","Vanilla","Cinnamon","Powdered Sugar"], subcategory:"Western Breakfast Favorites"},
  ...
  Lunch:[
    {id:101,name:"Garden Fresh Salad",image:"/images/fruitsalad.jpg",price:"Rs. 1,450",emoji:"🥗",color:"#F1F8E9",desc:"Crisp greens, cherry tomatoes, house vinaigrette",ingredients:["Mixed Greens","Cherry Tomatoes","Cucumber","Feta","Vinaigrette"]},
    {id:102,name:"Chicken Wrap",      image:"/images/Chicken Wrap.jpg",price:"Rs. 1,750",emoji:"🥙",color:"#E8F5E9",desc:"Grilled chicken, lettuce, tzatziki in flatbread", ingredients:["Chicken Breast","Flatbread","Lettuce","Tzatziki","Tomato"]},
    {id:103,name:"Club Sandwich",     image:"/images/WholeWheatSandwich.jpg",price:"Rs. 1,820",emoji:"🥪",color:"#FFF8E1",desc:"Triple-decker with turkey, bacon & avocado",     ingredients:["Turkey","Bacon","Avocado","Toasted Bread","Mayo"]},
    {id:104,name:"Tom Kha Soup",      image:"/images/Tom Kha Soup.jpg",price:"Rs. 1,600",emoji:"🍜",color:"#F3E5F5",desc:"Coconut broth with galangal & mushrooms",      ingredients:["Coconut Milk","Galangal","Mushrooms","Lemongrass","Lime"]},
  ...
  Dinner:[
    {id:201,name:"Grilled Ribeye",    image:"/images/Grilled Ribeye.jpg",price:"Rs. 4,800",emoji:"🥩",color:"#FBE9E7",desc:"300g prime ribeye, chimichurri & truffle fries",  ingredients:["Ribeye Steak","Chimichurri","Truffle","Fries","Rosemary"]},
    {id:202,name:"Roast Chicken",     image:"/images/Roast Chicken.jpg",price:"Rs. 3,340",emoji:"🍗",color:"#FFF8E1",desc:"Herb-rubbed half chicken with roasted vegetables",ingredients:["Chicken","Mixed Herbs","Root Vegetables","Garlic","Butter"]},
    {id:203,name:"Lamb Cutlets",      image:"/images/Lamb Cutlets.jpg",price:"Rs. 4,200",emoji:"🍖",color:"#FFEBEE",desc:"French-trimmed lamb with rosemary jus & gratin",  ingredients:["Lamb Cutlets","Rosemary","Potato Gratin","Red Wine Jus","Mint"]},
    {id:204,name:"Lobster Thermidor", image:"/images/fishrice.jpg",price:"Rs. 7,100",emoji:"🦞",color:"#FFF3E0",desc:"Whole lobster in creamy cognac & mustard sauce",   ingredients:["Lobster","Cognac","Mustard","Gruyère","Cream"]},
  ...
  Desserts:[
    {id:301,name:"Chocolate Fondant", image:"/images/chocolate_pancakes.jpg",price:"Rs. 1,450",emoji:"🍫",color:"#F3E5F5",desc:"Warm chocolate lava cake with vanilla ice cream",  ingredients:["Dark Chocolate","Eggs","Flour","Vanilla Ice Cream","Cocoa"]},
    {id:302,name:"NY Cheesecake",     image:"/images/NY Cheesecake.jpg",price:"Rs. 1,300",emoji:"🍰",color:"#FFF8E1",desc:"Velvety cream cheese on graham cracker base",     ingredients:["Cream Cheese","Graham Cracker","Eggs","Vanilla","Sour Cream"]},
    {id:303,name:"Crème Brûlée",      image:"/images/Crème Brûlée.jpg",price:"Rs. 1,230",emoji:"🍮",color:"#FFF3E0",desc:"Classic vanilla custard with caramelised top",  ingredients:["Heavy Cream","Eggs","Vanilla","Sugar","Caramel"]},
    {id:304,name:"Glazed Doughnuts",  image:"/images/muffin.jpg",price:"Rs. 1,015",emoji:"🍩",color:"#FCE4EC",desc:"Fresh-fried ring doughnuts with seasonal glazes",  ingredients:["Flour","Yeast","Sugar","Glaze","Sprinkles"]},
  ...
  Drinks:[
    {id:401,name:"Cold Brew Coffee",  image:"/images/Cold Brew Coffee.jpg",price:"Rs.  870",emoji:"☕",color:"#FFF8E1",desc:"18-hour steeped single-origin cold brew over ice",  ingredients:["Single Origin Coffee","Filtered Water","Ice","Optional Oat Milk"]},
    {id:402,name:"Mango Bubble Tea",  image:"/images/Mango Bubble Tea.jpg",price:"Rs.  940",emoji:"🧋",color:"#FFF3E0",desc:"Fresh mango milk tea with tapioca pearls",        ingredients:["Mango Puree","Milk Tea","Tapioca Pearls","Sugar","Ice"]},
    {id:403,name:"Green Smoothie",    image:"/images/Green Smoothie.jpg",price:"Rs. 1,160",emoji:"🥤",color:"#E8F5E9",desc:"Spinach, banana, mango, coconut water blend",      ingredients:["Spinach","Banana","Mango","Coconut Water","Chia Seeds"]},
    {id:404,name:"Classic Mojito",    image:"/images/Classic Mojito.jpg",price:"Rs. 1,450",emoji:"🍹",color:"#F1F8E9",desc:"Muddled mint, lime, rum & sparkling soda",       ingredients:["White Rum","Lime","Mint","Sugar","Soda Water"]},
