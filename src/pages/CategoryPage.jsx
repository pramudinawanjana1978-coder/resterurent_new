...
const categoryConfig = {
  ...
  Dinner: {
    ...
    slides:[
      [{image:"/images/Tostwithegg.jpg",name:"Grilled Steak"},
       {image:"/images/udechicken.png",name:"Roast Chicken"},
       {image:"/images/Tostwithegg.jpg",name:"Lamb Chops"},
       {image:"/images/Tostwithegg.jpg",name:"Lobster"},
       {image:"/images/Tostwithegg.jpg",name:"Sushi"},
       {image:"/images/Tostwithegg.jpg",name:"Tagine"},
       {image:"/images/Tostwithegg.jpg",name:"Braised Beef"},
       {image:"/images/Tostwithegg.jpg",name:"Hot Pot"}],
      [{image:"/images/Tostwithegg.jpg",name:"Prawns"},
        {image:"/images/fishrice.png",name:"Sea Bass"},
        {image:"/images/porkrice.png",name:"Pork Belly"},
        {image:"/images/Tostwithegg.jpg",name:"Duck Confit"},
        {image:"/images/Tostwithegg.jpg",name:"Niçoise"},
        {image:"/images/pancake2.jpg",name:"Carbonara"},
        {image:"/images/French_Toast.jpg",name:"Savoury Crepe"},
        {image:"/images/Tostwithegg.jpg",name:"French Onion Soup"}],
    ],
  },
  Desserts: {
    tagline:"Good Food,\nGood ", moodWord:"Sweet!",
    ...
    slides:[
      [{image:"/images/Tostwithegg.jpg",name:"Mousse"},{image:"/images/Tostwithegg.jpg",name:"Cheesecake"},{image:"/images/Tostwithegg.jpg",name:"Cake"},{image:"/images/Tostwithegg.jpg",name:"Crème Brûlée"},{image:"/images/Tostwithegg.jpg",name:"Doughnuts"},{image:"/images/Tostwithegg.jpg",name:"Cupcake"},{image:"/images/Tostwithegg.jpg",name:"Ice Cream"},{image:"/images/Tostwithegg.jpg",name:"Tart"}],
      [{image:"/images/Tostwithegg.jpg",name:"Candy"},{image:"/images/Tostwithegg.jpg",name:"Lollipop"},{image:"/images/Tostwithegg.jpg",name:"Cookies"},{image:"/images/Tostwithegg.jpg",name:"Pain au Chocolat"},{image:"/images/Tostwithegg.jpg",name:"Sorbet"},{image:"/images/Tostwithegg.jpg",name:"Dessert Waffle"},{image:"/images/Tostwithegg.jpg",name:"Pavlova"},{image:"/images/Tostwithegg.jpg",name:"Trifle"}],
    ],
  },
  Drinks: {
    tagline:"Good Vibes,\nGood ", moodWord:"Sip!",
    ...
    slides:[
      [{ image: "/images/Tostwithegg.jpg", name:"Espresso"},{image: "/images/Tostwithegg.jpg", name:"Bubble Tea"},{image: "/images/Tostwithegg.jpg", name:"Smoothie"},{image: "/images/Tostwithegg.jpg", name:"Cocktail"},{image: "/images/Tostwithegg.jpg", name:"Fresh OJ"},{image: "/images/Tostwithegg.jpg", name:"Matcha"},{image: "/images/Tostwithegg.jpg", name:"Cold Press"},{image: "/images/Tostwithegg.jpg", name:"Herbal Tea"}],
      [{image: "/images/Tostwithegg.jpg", name:"Craft Beer"},{image: "/images/Tostwithegg.jpg", name:"Red Wine"},{image: "/images/Tostwithegg.jpg", name:"Champagne"},{image: "/images/Tostwithegg.jpg", name:"Martini"},{image: "/images/Tostwithegg.jpg", name:"Iced Latte"},{image: "/images/Tostwithegg.jpg", name:"Lemonade"},{image: "/images/Tostwithegg.jpg", name:"Sparkling"},{image: "/images/Tostwithegg.jpg", name:"Sake"}],
    ],
  },
};
...
const allDishes = {
  ...
  Drinks:[
    ...
    {id:407,name:"Espresso",             image: "/images/Tostwithegg.jpg",   price:"Rs. 450",color:"#EFEBE9",desc:"Rich single-origin espresso shot — bold, intense and aromatic",                         rating:4.7,reviews:143,ingredients:["Espresso Roast Coffee Beans","Hot Water"],subcategory:"Hot Beverages"},
    {id:408,name:"Hot Chocolate",        image: "/images/Tostwithegg.jpg",   price:"Rs. 700", color:"#EFEBE9",desc:"Velvety Belgian dark chocolate melted into steamed milk with a whipped cream crown",    rating:4.9,reviews:234,ingredients:["Belgian Dark Chocolate","Whole Milk","Whipped Cream","Cocoa Powder","Sugar"],subcategory:"Hot Beverages"},
    {id:409,name:"Mocha Coffee",          image: "/images/Tostwithegg.jpg",  price:"Rs. 720", color:"#FBE9E7",desc:"Espresso combined with chocolate syrup and steamed milk — the best of both worlds",      rating:4.8,reviews:167,ingredients:["Espresso","Chocolate Syrup","Steamed Milk","Whipped Cream"],subcategory:"Hot Beverages"},
    {id:411,name:"Iced Coffee",          image: "/images/Tostwithegg.jpg",   price:"Rs. 700", color:"#E3F2FD",desc:"Chilled brewed coffee over ice with optional milk — your perfect afternoon pick-me-up",  rating:4.8,reviews:198,ingredients:["Brewed Coffee","Ice","Milk","Optional Sugar Syrup"],subcategory:"Iced Beverages"},
    {id:412,name:"Iced Latte",           image: "/images/Tostwithegg.jpg",   price:"Rs. 750", color:"#E3F2FD",desc:"Double espresso poured over ice with cold milk — cool, smooth and energising",           rating:4.8,reviews:212,ingredients:["Double Espresso","Cold Milk","Ice","Optional Syrup"],subcategory:"Iced Beverages"},
    {id:413,name:"Iced Mocha",            image: "/images/Tostwithegg.jpg",  price:"Rs. 800", color:"#EFEBE9",desc:"Espresso, chocolate syrup and cold milk shaken over ice — rich and refreshing",          rating:4.9,reviews:188,ingredients:["Espresso","Chocolate Syrup","Cold Milk","Ice","Whipped Cream"],subcategory:"Iced Beverages"},
    {id:414,name:"Iced Lemon Tea",        image: "/images/Tostwithegg.jpg",  price:"Rs. 450", color:"#FFFDE7",desc:"Chilled Ceylon tea with a bright squeeze of fresh lemon and a touch of sweetness",       rating:4.6,reviews:145,ingredients:["Ceylon Tea","Lemon Juice","Ice","Sugar Syrup","Mint"],subcategory:"Iced Beverages"},
    {id:415,name:"Cold Brew Coffee",      image: "/images/Tostwithegg.jpg",  price:"Rs. 870", color:"#FFF8E1",desc:"18-hour cold-steeped single-origin coffee — ultra-smooth with zero bitterness",          rating:4.9,reviews:178,ingredients:["Single Origin Coffee Beans","Filtered Water","Ice","Optional Oat Milk"],subcategory:"Iced Beverages"},
    {id:416,name:"Chocolate Milkshake",   image: "/images/Tostwithegg.jpg",  price:"Rs. 950", color:"#EFEBE9",desc:"Thick creamy chocolate milkshake blended with premium ice cream and real cocoa",         rating:4.9,reviews:267,ingredients:["Chocolate Ice Cream","Whole Milk","Chocolate Syrup","Whipped Cream","Chocolate Shavings"],subcategory:"Iced Beverages"},
    {id:417,name:"Vanilla Milkshake",     image: "/images/Tostwithegg.jpg",  price:"Rs. 900", color:"#FFF8E1",desc:"Classic thick vanilla milkshake made with real vanilla bean ice cream",                  rating:4.8,reviews:198,ingredients:["Vanilla Ice Cream","Whole Milk","Vanilla Extract","Whipped Cream"],subcategory:"Iced Beverages"},
    {id:418,name:"Strawberry Milkshake",  image: "/images/Tostwithegg.jpg",  price:"Rs. 950", color:"#FCE4EC",desc:"Vibrant fresh strawberry milkshake blended with real berries and ice cream",             rating:4.9,reviews:223,ingredients:["Fresh Strawberries","Strawberry Ice Cream","Whole Milk","Whipped Cream","Strawberry Syrup"],subcategory:"Iced Beverages"},
    {id:421,name:"Orange Juice",         image: "/images/Tostwithegg.jpg",   price:"Rs. 550", color:"#FFF3E0",desc:"Freshly squeezed Valencia oranges — pure, vibrant and vitamin-packed",                   rating:4.8,reviews:234,ingredients:["Fresh Oranges"],subcategory:"Fresh Fruit Juices"},
    {id:422,name:"Mango Juice",          image: "/images/Tostwithegg.jpg",   price:"Rs. 600", color:"#FFF3E0",desc:"Blended ripe Alphonso mangoes — sweet, tropical and intensely flavourful",               rating:4.9,reviews:312,ingredients:["Ripe Alphonso Mangoes","Optional Honey","Optional Lime"],subcategory:"Fresh Fruit Juices"},
    {id:423,name:"Pineapple Juice",      image: "/images/Tostwithegg.jpg",   price:"Rs. 550", color:"#FFFDE7",desc:"Cold-pressed fresh pineapple with a natural sweet-tangy tropical burst",                 rating:4.7,reviews:167,ingredients:["Fresh Pineapple","Optional Ginger","Optional Honey"],subcategory:"Fresh Fruit Juices"},
    {id:424,name:"Papaya Juice",         image: "/images/Tostwithegg.jpg",   price:"Rs. 500", color:"#FFF3E0",desc:"Smooth blended papaya juice with a touch of lime — light and digestive",                 rating:4.5,reviews:112,ingredients:["Fresh Papaya","Lime Juice","Optional Honey","Optional Ginger"],subcategory:"Fresh Fruit Juices"},
    {id:425,name:"Watermelon Juice",      image: "/images/Tostwithegg.jpg",  price:"Rs. 500", color:"#FCE4EC",desc:"Chilled fresh watermelon juice — hydrating, sweet and perfect for Sri Lanka's heat",     rating:4.8,reviews:198,ingredients:["Fresh Watermelon","Optional Lime","Optional Mint"],subcategory:"Fresh Fruit Juices"},
    {id:426,name:"Passion Fruit Juice",   image: "/images/Tostwithegg.jpg",  price:"Rs. 650", color:"#FFF9C4",desc:"Tangy tropical passion fruit juice bursting with exotic sun-kissed flavour",              rating:4.8,reviews:178,ingredients:["Fresh Passion Fruit","Sugar Syrup","Water","Optional Lime"],subcategory:"Fresh Fruit Juices"},
    {id:427,name:"Lime Juice",            image: "/images/Tostwithegg.jpg",  price:"Rs. 400", color:"#F1F8E9",desc:"Refreshing fresh lime juice — sweet, salty or plain as you like it",                     rating:4.7,reviews:245,ingredients:["Fresh Limes","Water","Sugar","Optional Salt"],subcategory:"Fresh Fruit Juices"},
    {id:428,name:"Mixed Fruit Juice",     image: "/images/Tostwithegg.jpg",  price:"Rs. 700", color:"#EDE7F6",desc:"A seasonal blend of tropical fruits — mango, pineapple, orange and passion fruit",       rating:4.8,reviews:156,ingredients:["Mango","Pineapple","Orange","Passion Fruit","Optional Honey"],subcategory:"Fresh Fruit Juices"},
    {id:431,name:"King Coconut (Thambili)", image: "/images/Tostwithegg.jpg", price:"Rs. 350",color:"#FFF3E0",desc:"Fresh Sri Lankan king coconut water served chilled — nature's own electrolyte drink",   rating:4.9,reviews:456,ingredients:["King Coconut Water"],subcategory:"Sri Lankan Special Drinks"},
    {id:432,name:"Wood Apple Juice",      image: "/images/Tostwithegg.jpg",  price:"Rs. 450", color:"#FFF8E1",desc:"Unique tangy-sweet Sri Lankan wood apple blended with coconut milk and jaggery",         rating:4.7,reviews:134,ingredients:["Wood Apple","Coconut Milk","Jaggery","Water"],subcategory:"Sri Lankan Special Drinks"},
    {id:433,name:"Belimal Drink",         image: "/images/Tostwithegg.jpg",  price:"Rs. 400", color:"#E8F5E9",desc:"Traditional bael fruit cooler — soothing, aromatic and deeply refreshing",               rating:4.7,reviews:98, ingredients:["Bael Fruit","Jaggery","Water","Optional Lime"],subcategory:"Sri Lankan Special Drinks"},
    {id:434,name:"Ranawara Drink",        image: "/images/Tostwithegg.jpg",  price:"Rs. 380", color:"#FFFDE7",desc:"Golden herbal ranawara flower infusion with honey — a traditional wellness drink",        rating:4.6,reviews:78, ingredients:["Ranawara Flowers","Honey","Hot Water"],subcategory:"Sri Lankan Special Drinks"},
    {id:435,name:"Ginger Beer",           image: "/images/Tostwithegg.jpg",  price:"Rs. 500", color:"#FFF3E0",desc:"Spicy homemade ginger beer with a fiery kick and natural fizz",                          rating:4.8,reviews:167,ingredients:["Fresh Ginger","Sugar","Yeast","Lime","Water"],subcategory:"Sri Lankan Special Drinks"},
    {id:436,name:"Faluda",                image: "/images/Tostwithegg.jpg",  price:"Rs. 650", color:"#FCE4EC",desc:"The iconic Sri Lankan Faluda — rose milk, basil seeds, noodles and ice cream",           rating:4.9,reviews:312,ingredients:["Rose Syrup","Basil Seeds","Faluda Noodles","Milk","Vanilla Ice Cream","Agar Jelly"],subcategory:"Sri Lankan Special Drinks"},
    {id:437,name:"Avocado Juice",         image: "/images/Tostwithegg.jpg",  price:"Rs. 700", color:"#E8F5E9",desc:"Creamy blended avocado with milk and a touch of honey — rich, smooth and nutritious",    rating:4.8,reviews:189,ingredients:["Ripe Avocado","Milk","Honey","Ice"],subcategory:"Sri Lankan Special Drinks"},
    {id:438,name:"Soursop Juice",         image: "/images/Tostwithegg.jpg",  price:"Rs. 750", color:"#E8F5E9",desc:"Velvety soursop blended with coconut milk — tropical, creamy and uniquely delicious",    rating:4.8,reviews:143,ingredients:["Fresh Soursop","Coconut Milk","Sugar","Ice"],subcategory:"Sri Lankan Special Drinks"},
    {id:441,name:"Virgin Mojito",         image: "/images/Tostwithegg.jpg",  price:"Rs. 750", color:"#E8F5E9",desc:"Muddled mint, lime, sugar and soda — the classic refresher without the alcohol",         rating:4.8,reviews:289,ingredients:["Fresh Mint","Lime","Sugar Syrup","Soda Water","Ice","Lime Slice"],subcategory:"Mocktails"},
    {id:442,name:"Blue Lagoon Mocktail",  image: "/images/Tostwithegg.jpg",  price:"Rs. 800", color:"#E3F2FD",desc:"Dazzling blue curacao syrup, lemon juice and soda — visually stunning and refreshing",   rating:4.8,reviews:198,ingredients:["Blue Curacao Syrup","Lemon Juice","Soda Water","Ice","Lemon Slice"],subcategory:"Mocktails"},
    {id:443,name:"Tropical Sunset",       image: "/images/Tostwithegg.jpg",  price:"Rs. 850", color:"#FFF3E0",desc:"Mango, passion fruit and orange layered for a stunning tropical sunset effect",           rating:4.9,reviews:212,ingredients:["Mango Juice","Passion Fruit Juice","Orange Juice","Grenadine","Ice"],subcategory:"Mocktails"},
    {id:444,name:"Mango Mint Cooler",     image: "/images/Tostwithegg.jpg",  price:"Rs. 750", color:"#FFF3E0",desc:"Fresh mango blended with mint and lime over crushed ice — cooling and tropical",          rating:4.7,reviews:167,ingredients:["Fresh Mango","Mint","Lime","Sugar Syrup","Crushed Ice"],subcategory:"Mocktails"},
    {id:445,name:"Citrus Splash",         image: "/images/Tostwithegg.jpg",  price:"Rs. 700", color:"#FFF3E0",desc:"Orange, lemon and lime juices combined with soda for a zesty citrus explosion",           rating:4.6,reviews:134,ingredients:["Orange Juice","Lemon Juice","Lime Juice","Soda Water","Honey","Ice"],subcategory:"Mocktails"},
    {id:446,name:"Pineapple Cooler",      image: "/images/Tostwithegg.jpg",  price:"Rs. 700", color:"#FFFDE7",desc:"Fresh pineapple juice with coconut water, lime and crushed ice — tropical bliss",         rating:4.7,reviews:145,ingredients:["Pineapple Juice","Coconut Water","Lime","Mint","Crushed Ice"],subcategory:"Mocktails"},
    {id:447,name:"Strawberry Lemonade",  image: "/images/Tostwithegg.jpg",   price:"Rs. 750", color:"#FCE4EC",desc:"House-made lemonade blended with fresh strawberries — sweet, tart and irresistible",     rating:4.9,reviews:245,ingredients:["Fresh Strawberries","Lemon Juice","Sugar Syrup","Soda Water","Ice"],subcategory:"Mocktails"},
    {id:448,name:"Passion Fruit Fizz",    image: "/images/Tostwithegg.jpg",  price:"Rs. 800", color:"#FFF9C4",desc:"Tropical passion fruit syrup topped with sparkling water and fresh lime zest",            rating:4.8,reviews:178,ingredients:["Passion Fruit Syrup","Sparkling Water","Lime Juice","Ice","Lime Zest"],subcategory:"Mocktails"},
    {id:451,name:"Coca-Cola",            image: "/images/Tostwithegg.jpg",   price:"Rs. 300",color:"#FFEBEE",desc:"The world's favourite cola served chilled over ice with a slice of lime",                rating:4.5,reviews:312,ingredients:["Coca-Cola","Ice","Optional Lime"],subcategory:"Soft Drinks"},
    {id:452,name:"Diet Coke",            image: "/images/Tostwithegg.jpg",   price:"Rs. 300", color:"#F3E5F5",desc:"Classic Coca-Cola flavour with zero sugar — light, crisp and refreshing",                rating:4.3,reviews:145,ingredients:["Diet Coke","Ice","Optional Lime"],subcategory:"Soft Drinks"},
    {id:453,name:"Sprite",                image: "/images/Tostwithegg.jpg",  price:"Rs. 300", color:"#E8F5E9",desc:"Crisp lemon-lime sparkling drink — clean, fresh and perfectly carbonated",                rating:4.5,reviews:198,ingredients:["Sprite","Ice","Optional Lemon"],subcategory:"Soft Drinks"},
    {id:454,name:"Fanta Orange",          image: "/images/Tostwithegg.jpg",  price:"Rs. 300", color:"#FFF3E0",desc:"Vibrant orange-flavoured fizzy drink — fruity, fun and full of bubbles",                  rating:4.4,reviews:167,ingredients:["Fanta Orange","Ice"],subcategory:"Soft Drinks"},
    {id:455,name:"Ginger Ale",            image: "/images/Tostwithegg.jpg",  price:"Rs. 350",color:"#E8F5E9",desc:"Light ginger-flavoured sparkling drink — perfect for settling the stomach",               rating:4.4,reviews:112,ingredients:["Ginger Ale","Ice","Optional Lime"],subcategory:"Soft Drinks"},
    {id:456,name:"Soda Water",            image: "/images/Tostwithegg.jpg",  price:"Rs. 200", color:"#E3F2FD",desc:"Plain sparkling water — clean bubbles, crisp and purely refreshing",                      rating:4.3,reviews:89, ingredients:["Carbonated Water","Ice"],subcategory:"Soft Drinks"},
    {id:457,name:"Tonic Water",           image: "/images/Tostwithegg.jpg",  price:"Rs. 250", color:"#E3F2FD",desc:"Quinine-infused sparkling water with a pleasantly bitter finish",                        rating:4.2,reviews:67, ingredients:["Tonic Water","Ice","Optional Lime"],subcategory:"Soft Drinks"},
    {id:461,name:"Mineral Water (500ml)", image: "/images/Tostwithegg.jpg",  price:"Rs. 150",color:"#E3F2FD",desc:"Premium still mineral water — pure, natural and perfectly hydrating",                    rating:4.5,reviews:445,ingredients:["Natural Mineral Water"],subcategory:"Water & Refreshments"},
    {id:462,name:"Mineral Water (1L)",   image: "/images/Tostwithegg.jpg",   price:"Rs. 250", color:"#E3F2FD",desc:"Large still mineral water — share with your table or keep one for yourself",              rating:4.5,reviews:312,ingredients:["Natural Mineral Water"],subcategory:"Water & Refreshments"},
    {id:463,name:"Sparkling Water",       image: "/images/Tostwithegg.jpg",  price:"Rs. 350", color:"#E3F2FD",desc:"Naturally carbonated sparkling mineral water with fine, persistent bubbles",              rating:4.4,reviews:134,ingredients:["Sparkling Mineral Water","Ice","Optional Lime"],subcategory:"Water & Refreshments"},
    {id:464,name:"Lemon Water",           image: "/images/Tostwithegg.jpg",  price:"Rs. 200", color:"#FFFDE7",desc:"Still water infused with fresh lemon slices and mint — light and cleansing",              rating:4.6,reviews:198,ingredients:["Water","Fresh Lemon Slices","Mint","Ice"],subcategory:"Water & Refreshments"},
    {id:471,name:"Tropical Paradise",     image: "/images/Tostwithegg.jpg",  price:"Rs. 1,200",color:"#FFF3E0",desc:"Our house signature — mango, passion fruit and coconut blended to tropical perfection",  rating:4.9,reviews:312,ingredients:["Mango Puree","Passion Fruit Juice","Coconut Cream","Pineapple Juice","Ice","Mint"],subcategory:"Signature Drinks"},
    {id:472,name:"Coconut Mango Smoothie", image: "/images/Tostwithegg.jpg", price:"Rs. 1,050",color:"#FFF3E0",desc:"Velvety mango and coconut cream smoothie — thick, tropical and utterly indulgent",        rating:4.9,reviews:267,ingredients:["Ripe Mango","Coconut Cream","Banana","Honey","Ice"],subcategory:"Signature Drinks"},
    {id:473,name:"Berry Blast Smoothie",   image: "/images/Tostwithegg.jpg", price:"Rs. 1,100",color:"#EDE7F6",desc:"Mixed berries, banana and Greek yogurt blended into a vibrant antioxidant powerhouse",  rating:4.8,reviews:198,ingredients:["Mixed Berries","Banana","Greek Yogurt","Honey","Ice","Milk"],subcategory:"Signature Drinks"},
    {id:474,name:"Pineapple Mint Cooler", image: "/images/Tostwithegg.jpg",  price:"Rs. 950", color:"#FFFDE7",desc:"Fresh pineapple blended with mint, lime and coconut water — pure tropical refreshment",   rating:4.8,reviews:178,ingredients:["Fresh Pineapple","Mint","Lime","Coconut Water","Ice","Honey"],subcategory:"Signature Drinks"},
    {id:475,name:"Mango Passion Delight", image: "/images/Tostwithegg.jpg",  price:"Rs. 1,050",color:"#FFF3E0",desc:"Layered mango and passion fruit juice with basil seeds and lime foam — stunning",        rating:4.9,reviews:234,ingredients:["Mango Juice","Passion Fruit Juice","Basil Seeds","Lime Foam","Ice"],subcategory:"Signature Drinks"},
    {id:476,name:"Chocolate Banana Shake", image: "/images/Tostwithegg.jpg", price:"Rs. 1,000",color:"#EFEBE9",desc:"Thick chocolate shake blended with ripe banana and Nutella — indulgent and filling",     rating:4.8,reviews:189,ingredients:["Banana","Chocolate Ice Cream","Nutella","Milk","Whipped Cream","Chocolate Sauce"],subcategory:"Signature Drinks"},
    {id:477,name:"Green Detox Smoothie",   image: "/images/Tostwithegg.jpg", price:"Rs. 950", color:"#E8F5E9",desc:"Spinach, cucumber, green apple, ginger and lime — a rejuvenating green power drink",      rating:4.7,reviews:145,ingredients:["Spinach","Cucumber","Green Apple","Ginger","Lime","Coconut Water","Ice"],subcategory:"Signature Drinks"},
    {id:478,name:"Sunset Breeze Mocktail", image: "/images/Tostwithegg.jpg", price:"Rs. 1,100",color:"#FFF3E0",desc:"Guava, orange and lime with grenadine sunset swirl — beautiful and boldly tropical",      rating:4.9,reviews:223,ingredients:["Guava Juice","Orange Juice","Lime","Grenadine","Soda Water","Ice","Orange Slice"],subcategory:"Signature Drinks"},
  ],
};
