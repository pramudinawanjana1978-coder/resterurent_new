...
const currentOffers = [
  {
    ...
    tag: "🔥 Popular",
    items: [
      { id: "oi1", name: "Mixed Rice & Curry", image: "/images/mixrice.png", price: 1400, qty: 4, originalPrice: 1750, category: "Dinner"  },
      { id: "oi2", name: "Chicken Kottu", image: "/images/ChickenKottu.jpg", price: 1200, qty: 2, originalPrice: 1500, category: "Dinner" },
      { id: "oi3", name: "Fresh Fruit Platter", image: "/images/Fresh Fruit Platter.jpg", price: 850, qty: 1, originalPrice: 1050, category: "Desserts" },
    ]
  },
  {
    id: "o2",
    ...
    code: "HAPPYHR",
    expires: "Daily 3–5 PM",
    tag: "⏰ Time-Limited",
    items: [
      { id: "oi4", name: "Virgin Mojito", image: "/images/Virgin Mojito.jpg", price: 600, qty: 2, originalPrice: 1200, category: "Drinks" },
      { id: "oi5", name: "Mango Juice", image: "/images/Mango Juice .jpg", price: 450, qty: 2, originalPrice: 900, category: "Drinks" },
      { id: "oi6", name: "King Coconut (Thambili)", image: "/images/Thambili.jpg", price: 300, qty: 2, originalPrice: 600, category: "Drinks" },
    ]
  },
  {
    id: "o3",
    ...
    code: "WELCOME20",
    expires: "New customers only",
    tag: "🆕 New Here?",
    items: [
      { id: "oi7", name: "Blueberry Pancakes", image: "/images/pancakes.jpg", price: 1850, qty: 1, originalPrice: 2310, category: "Breakfast" },
      { id: "oi8", name: "Ceylon Black Tea", image: "/images/black_tea.jpg", price: 250, qty: 1, originalPrice: 310, category: "Drinks"},
      { id: "oi9", name: "Watalappan", image: "/images/Watalappan.jpg", price: 650, qty: 1, originalPrice: 810, category: "Desserts" },
    ]
  },
  {
    id: "o4",
    ...
    tag: "🍰 Sweet Deal",
    items: [
      { id: "oi10", name: "Tiramisu", image: "/images/Tiramisu.jpg", price: 1050, qty: 1, originalPrice: 1235, category: "Desserts" },
      { id: "oi11", name: "Chocolate Brownie", image: "/images/Chocolate Fondant.jpg", price: 800, qty: 1, originalPrice: 940, category: "Desserts" },
    ]
  },
  {
    id: "o5",
    ...
    code: "LUNCH300",
    expires: "Weekdays 11:30–2",
    tag: "⚡ Quick Save",
    items: [
      { id: "oi12", name: "Chicken Wrap", image: "/images/Chicken Wrap.jpg", price: 1750, qty: 1, originalPrice: 2050, category: "Lunch" },
      { id: "oi13", name: "Orange Juice", image: "/images/Orange Juice.jpg", price: 400, qty: 1, originalPrice: 700, category: "Drinks"},
    ]
  },
  {
    id: "o6",
    ...
    code: "BDAYFREE",
    expires: "Your birthday only",
    tag: "🎂 Celebrate",
    items: [
      { id: "oi14", name: "Watalappan", image: "/images/Watalappan.jpg", price: 0, qty: 1, originalPrice: 650, category: "Desserts" },
      { id: "oi15", name: "Cappuccino", image: "/images/Cappuccino.jpg", price: 500, qty: 1, originalPrice: 500, category: "Drinks" },
    ]
  },
];
...
export default function OffersPage({ onBack, accentColor = "#f97316", onGoToCart, cartItems = [], setCartItems }) {
  ...
  // Helper to render item thumbnail (image or emoji fallback)
  const renderItemThumbnail = (item, itemAdded, offerColor) => {
    const containerStyle = {
      ...
      background: itemAdded
        ...
        : `linear-gradient(135deg,${offerColor}33,${offerColor}18)`,
      display: "flex",
      alignItems: "center",
    ...
    return (
      <div style={containerStyle}>
        ...
        {/* Always render emoji as fallback behind image */}
        <span
          ...
          style={{
            ...
            position: "relative",
            zIndex: 1,
            display: item.image ? "block" : "block",
          }}
        >
          {item.emoji || ""}
        </span>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f4f1ed", fontFamily: "'Trebuchet MS',sans-serif", color: "#111827" }}>
                        ...
                        {o.items.map(item => {
                          ...
                          return (
                            <div key={item.id} style={{
                              ...
                              {renderItemThumbnail(item, itemAdded, o.color)}
      ...
      <style>{`
        ...
        @keyframes cartSlide  { from{transform:translateX(-50%) translateY(80px);opacity:0} to{transform:translateX(-50%) translateY(0);opacity:1} }
      `}</style>
      ...
      {cartCount > 0 && (
        <div style={{
          ...
          zIndex: 300,
          animation: "cartSlide 0.4s cubic-bezier(0.34,1.56,0.64,1)",
