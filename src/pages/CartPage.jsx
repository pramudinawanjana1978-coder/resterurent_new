...
function CartPage({
  ...
  const subtotal = items.reduce(
    (sum, item) =>
      sum + getNumericPrice(item.price) * (item.qty || 0),
    0
  );
            ...
            {Object.entries(
              ...
              <div
                ...
                style={{
                  ...
                  border: `1px solid ${
                    catColors[category] || accentColor
                  }44`,
                  borderRadius: 20,
                  padding: "5px 12px",
                  display: "flex",
      ...
      >
        ...
        >
          ...
          >
            ...
            {items.map((item) => {
              const catColor =
                catColors[item.category] || accentColor;
            ...
            >
              ...
              >
                ...
                <div
                  style={{
                    height: 1,
                    background: `linear-gradient(90deg,${accentColor}44,${accentColor}11)`,
                    marginBottom: 14,
                  }}
                />
        ...
        >
          <div
            ...
            style={{
              ...
              overflow: "hidden",
              animation:
                "schedPop 0.3s cubic-bezier(0.34,1.56,0.64,1)",
            }}
          >
            {/* Modal Header */}
            ...
            >
              ...
              >
                ...
                <textarea
                  ...
                  placeholder="e.g. Please deliver to Table 5..."
                  rows={3}
                  style={{
                    width: "100%",
                    boxSizing:
